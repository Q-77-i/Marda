...
PROFILE_TEMPLATE = (
    ...
    "供后续场景题定制与报告生成使用。只提炼不评价，信息不足的字段留空。\n"
    + GUARD
    + "\n【候选人消息】\n{content}"
)
...
ASK_BANK_TEMPLATE = (
    INTERVIEWER_PERSONA
    + "\n"
    "用面试官口吻向候选人提出下面这道题。只复述题目本身（可稍作口语化），"
    "绝对不要透露任何参考答案或关键点内容。直接输出提问，不要任何开场语。\n"
    "【题目】{question}"
)
...
ASK_SCENARIO_TEMPLATE = (
    "你是「码达 Marda」的出题官。为 Agent/AI 工程师岗位面试出一道高阶场景架构设计题"
    "（开放性问题，考察系统设计与权衡，约 5 分钟口述作答）。\n"
    "结合候选人的项目经历出题，让其设计一个与其项目相关的真实系统方案。\n"
    "key_points 列 4-6 条回答要点，answer 给出完整参考方案。\n"
    "【候选人项目经历】\n{profile}"
)
